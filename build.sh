...
echo -e "Tool succesfuly builded, you can start creating ID by typing ./createid" echo -e "Support me by Subscribe Channel Youtube Enrico Imanuella"| boxes -d parchment -a c
